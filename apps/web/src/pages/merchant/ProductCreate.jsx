  ...
  const categories = [
    {
      id: "food",
      name: "Food",
      icon: <FiShoppingBag className="w-4 h-4 text-orange-600" />,
    },
    {
      id: "groceries",
      name: "Groceries",
      icon: <FiShoppingCart className="w-4 h-4 text-green-600" />,
    },
    {
      id: "pharmacy",
      name: "Pharmacy",
      icon: <FiHeart className="w-4 h-4 text-pink-600" />,
    },
    {
      id: "electronics",
      name: "Electronics",
      icon: <FiCpu className="w-4 h-4 text-blue-600" />,
    },
    {
      id: "clothing",
      name: "Clothing",
      icon: <FiPackage className="w-4 h-4 text-purple-600" />,
    },
    {
      id: "books",
      name: "Books",
    ...
    },
    {
      id: "other",
      name: "Other",
      icon: <FiBox className="w-4 h-4 text-gray-600" />,
    },
  ];
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const value = e.target.value;
                        // Allow only digits (no decimals or negative numbers)
                        if (/^\d*$/.test(value)) {
                          setStock(value);
                        }
                      }}
