...
export default function ProductView(){
  ...
  if(!product) return <div className="p-3">Not found</div>
  ...
  return (
    <div className="p-3 pb-16">
      <div className="flex items-center justify-between mb-3">
        ...
        <button className="flex items-center gap-2 text-blue-600" onClick={()=>navigate(`/merchant/products/${product._id}/edit`)}><FiEdit2 /> Edit</button>
      </div>
