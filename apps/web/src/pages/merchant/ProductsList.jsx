...
import { 
  FiPlus, FiTrash2, FiEdit2, FiPackage, FiSearch, 
  FiFilter, FiBox, FiDollarSign, FiActivity 
} from 'react-icons/fi'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50/30 p-4 pb-24">
      ...
      <motion.div
        ...
        className="sticky top-0 z-20 bg-white/90 backdrop-blur-lg rounded-3xl shadow-lg border border-orange-100 p-4 mb-5 flex items-center justify-between"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Manage your catalog</p>
          </div>
        </div>
        ...
        <motion.button
          ...
          className="p-3 bg-orange-500 text-white rounded-2xl shadow-md hover:bg-orange-600 transition-all"
        >
      ...
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="flex overflow-x-auto gap-3 pb-2 scrollbar-hide mb-4"
      >
        <div className="flex-shrink-0 bg-white/90 backdrop-blur-md rounded-2xl shadow-sm border border-orange-100 p-3 text-center min-w-[100px]">
      ...
      <motion.div
        ...
        className="bg-white/90 backdrop-blur-md rounded-3xl shadow-sm border border-orange-100 p-4 flex flex-col sm:flex-row gap-3 items-center"
      >
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full border border-gray-200 rounded-2xl pl-9 pr-4 py-2.5 bg-gray-50/50 focus:bg-white focus:border-orange-300 focus:ring-2 focus:ring-orange-100 outline-none transition-all"
          />
        </div>
        ...
        <div className="relative w-full sm:w-auto">
          ...
          <select
            ...
            className="w-full sm:w-auto border border-gray-200 rounded-2xl pl-9 pr-4 py-2.5 bg-gray-50/50 focus:bg-white focus:border-orange-300 focus:ring-2 focus:ring-orange-100 appearance-none outline-none transition-all"
          >
      ...
      {loading && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-orange-100 p-8 text-center mt-6"
        >
                  ...
                  >
                    ...
                    {p.status && (
                      <div className="absolute top-3 right-3">
                        <div
                          className={`px-2 py-1 rounded-full border text-xs font-medium flex items-center gap-1 ${getStatusColor(
                            p.status
                          )}`}
                        >
